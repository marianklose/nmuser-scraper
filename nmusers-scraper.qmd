...
# define query
query = 'mutation{createDiscussion(input: {repositoryId: "R_kgDOKYhvWw", categoryId: "DIC_kwDOKYhvW84CZobi", body: "This is the first discussion created via python!", title: "Received from Python"}) {discussion {id}}}'
